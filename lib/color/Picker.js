  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ColorPickerWrapper,
        { className: 'ld-color-picker-wrapper' },
        _react2.default.createElement(
          CloseWrapper,
          { className: 'ld-color-picker-close-wrapper', onClick: this.props.closeModal },
          _react2.default.createElement(
            Close,
            { width: '24', height: '24', viewBox: '0 0 24 24', className: 'ld-color-picker-close' },
            _react2.default.createElement(
              'g',
        ...
        _react2.default.createElement(
          ColorWrapper,
          { className: 'ld-color-picker' },
          _colors.colors.map(function (c, i) {
            return _react2.default.createElement(ColorSpan, { className: 'ld-color-picker-item', key: i, color: c, onClick: function onClick() {
